 ...
 */
public class GLMWithSmoothScroller extends GridLayoutManager
{
     ...
     */
    public GLMWithSmoothScroller(Context context, int spanCount, float speed)
    {
    ...
    private class SmoothScroller extends LinearSmoothScroller
    {
        ...
        {
            return GLMWithSmoothScroller.this
