...
public class SunriseSunset
{
     ...
     *
     * @param tile an object containing weather information about a city.
     * @return whether is daytime (true) or nighttime (false).
     */
    public static Boolean isDayTime(Tile tile)
    {
        Calendar calendar = Calendar.getInstance();
        double now = Util.getTimeNowInDecimals(calendar, tile.getTimeZone());
        return (tile.getSunrise() < now && tile.getSunset() > now);
    }
     ...
     * @return whether is daytime (true) or nighttime (false).
     */
    static Boolean isDayTime(double lat, double lon, String timeZoneId)
    {
        Calendar calendar = Calendar.getInstance();
    ...
    static double getSunrise() { return sunrise; }

    static double getSunset() { return sunset; }
